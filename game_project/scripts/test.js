...
function init() {
    ...
    imgMonsterAIdle.src = "img/ninja.png";
}
...
function startGame() {
    ...
    var spriteSheet = new createjs.SpriteSheet({
        ...
        frames: { width: 50, height: 77, regX: 32, regY: 32 },
    ...
    var spriteSheetIdle = new createjs.SpriteSheet({
        ...
        frames: { width: 50, height: 77, regX: 0, regY: 0 },
        animations: {
            idle: [0, 0, "idle", 6]
        }
    });
    ...
    bmpAnimationIdle.x = 0;
    bmpAnimationIdle.y = 0;
